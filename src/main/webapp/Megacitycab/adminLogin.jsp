    ...
    <div class="form-container">
        ...
        <form id="adminLoginForm">
            ...
            <div class="input-group">
                ...
                <input type="email" id="adminLoginEmail" name="email" placeholder="Email" required>
            </div>
            <div class="input-group password-container">
                <i class="fas fa-lock"></i>
                <input type="password" id="adminLoginPassword" name="password" placeholder="Password" required>
                <span class="toggle-password" onclick="togglePassword('adminLoginPassword')">👁</span>
            </div>
