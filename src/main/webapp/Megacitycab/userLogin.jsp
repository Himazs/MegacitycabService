    ...
    <div class="form-container">
        ...
        <form id="userLoginForm">
            ...
            <div class="input-group">
                ...
                <input type="email" id="userLoginEmail" name="email" placeholder="Email" required>
            </div>
            <div class="input-group password-container">
                <i class="fas fa-lock"></i>
                <input type="password" id="userLoginPassword" name="password" placeholder="Password" required>
                <span class="toggle-password" onclick="togglePassword('userLoginPassword')">👁</span>
            </div>
            <button type="submit"><i class="fas fa-sign-in-alt button-icon"></i>Login</button>
            <a class="toggle-form-link" href="userSignup.jsp">Don't have an account? Sign Up</a>
        </form>
    </div>
