...
<body>
    <div class="container">
        <div class="header">
            <h1>MegaCityCab - Car Management</h1>
        </div>
        ...
        try {
            ...
            String sql = "SELECT * FROM car_new";
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <form action="removeCar.jsp" method="post" style="display:inline;">
            ...
            %>
            <div class="no-data">
                No car records available at this time.
            </div>
            <%
                }
            } catch (Exception e) {
