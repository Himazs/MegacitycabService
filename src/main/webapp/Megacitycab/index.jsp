...
<body>
   ...
   <div class="role-buttons">
    <a href="http://localhost:8080/Citycab/Megacitycab/userLogin.jsp">
        <i class="fas fa-user button-icon"></i>
        <br>
        <div>User</div>
    </a>
    <a href="http://localhost:8080/Citycab/Megacitycab/driverLogin.jsp">
        <i class="fas fa-car button-icon"></i>
        <br>
        <div>Driver</div>
    </a>
    <a href="http://localhost:8080/Citycab/Megacitycab/adminLogin.jsp">
